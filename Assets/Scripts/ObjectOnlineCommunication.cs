...
=======
        ...
        {
            // �f�[�^�� char_index�i�������l�̐F�j����A�o���ׂ��e�̃v���n�u�����߂�
            ...
            if (projectilePrefabs != null && bulletType < projectilePrefabs.Length && projectilePrefabs[bulletType] != null)
            {
                ...
                Debug.Log("[�C�x���g��������] ���肪�������e�����[�J���Ŕ��˂��܂����B");
            }
            return; // �e�̏����͂����Ŋ��S�ɏI���I
        }


        // �����̃I�u�W�F�N�g�A�������͏�ŐV�����������ꂽ�e�̍��W���X�V����
>>>>>>> origin/WR_new
